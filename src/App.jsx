...
/* role-line icons */
const IcoGrad  = () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></svg>
const IcoDev   = () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>
const IcoAI    = () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="10" rx="2"/><circle cx="12" cy="5" r="2"/><path d="M12 7v4M8 11V9M16 11V9"/><path d="M8 16h.01M12 16h.01M16 16h.01"/></svg>
const IcoGame  = () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="6" width="20" height="12" rx="2"/><path d="M12 12h.01M7 12v-2M7 10v2M7 12h2M17 12h-2"/></svg>
...
const IcoZap   = () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>
const IcoSword = () => <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="14.5 17.5 3 6 3 3 6 3 17.5 14.5"/><line x1="13" y1="19" x2="19" y2="13"/><line x1="16" y1="16" x2="20" y2="20"/><line x1="19" y1="21" x2="21" y2="19"/></svg>
      ...
      <div className="hero-inner">
        ...
        <div className="hero-text" ref={ref}>
          ...
          <div className="hero-role-box ha" style={{ opacity:0 }}>
            <div className="role-line"><span className="role-icon"><IcoGrad /></span><span><strong>Ingeniero Civil en Informática</strong></span></div>
            <div className="role-line"><span className="role-icon"><IcoDev /></span><span>Especialidad en <strong>Desarrollo de Software</strong></span></div>
            <div className="role-line"><span className="role-icon"><IcoAI /></span><span><strong>IA Engineer</strong> · ERP &amp; Intranets a medida</span></div>
            <div className="role-line"><span className="role-icon"><IcoGame /></span><span><strong>Diseñador de Videojuegos</strong></span></div>
            <div className="role-line"><span className="role-icon"><IcoTools /></span><span>Técnico Computacional · <strong>Refresca Tu Nae</strong></span></div>
          </div>

          <div className="xp-panel ha" style={{ opacity:0 }}>
            <div className="xp-header">
              <span className="xp-level"><IcoSword /> LVL 29 · FULL STACK DEV</span>
          ...
          <div className="hero-ctas ha" style={{ opacity:0 }}>
            <a href="#projects" className="btn-ps"><IcoZap /> VER PROYECTOS</a>
